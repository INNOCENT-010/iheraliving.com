...
export default function EnquiriesPage() {
  ...
  return (
    <div
      className="flex h-[calc(100vh-56px)] lg:h-screen overflow-hidden admin-dark"
          ...
          >
            {STATUS_FILTERS.map(f => (
              <button
                key={f}
                onClick={() => setFilter(f)}
                className="font-body text-[8px] tracking-widest uppercase px-3 py-2 capitalize border-b-2 -mb-px shrink-0"
                style={{
          ...
          >
            <div className="text-center">
              <div
                ...
                style={{ backgroundColor: 'rgba(184,146,74,0.3)' }}
              />
